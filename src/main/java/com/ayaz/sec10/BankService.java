package com.ayaz.sec10;

import com.ayaz.models.sec10.*;
import com.ayaz.sec10.repository.AccountRepository;
import com.ayaz.sec10.validator.RequestValidator;
...
public class BankService extends BankServiceGrpc.BankServiceImplBase {
    ...
    public void withdraw(WithdrawRequest request, StreamObserver<Money> responseObserver) {
        ...
        RequestValidator.validateAccount(request.getAccountNumber())
                .or(() -> RequestValidator.validateAmountDivisibleBy10(request.getAmount()))
