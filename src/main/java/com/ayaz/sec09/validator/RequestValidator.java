package com.ayaz.sec09.validator;
...
public class RequestValidator {
    ...
    public static Optional<Status> validateAmountDivisibleBy10(int amount) {
        if(amount > 0 && amount % 10 == 0) {
            return Optional.empty();
        }
        return Optional.of(Status.INVALID_ARGUMENT.withDescription("Account number should be 10 multiples"));
    }
