...
import com.ayaz.models.sec03.BodyStyle;
import com.ayaz.models.sec03.Car;
import com.ayaz.models.sec03.Dealer;
...
public class Lec06Map {
    ...
    public static void main(String[] args) {
        ...
        // check based on key, Returns true or false
        ...
        // get inventory Count
        log.info("Inventory Count: {}", dealer.getInventoryCount());
